#!/bin/sh
RAM_MIN=512  # Minimum use of Memory
RAM_MAX=1024 # Maximum use of Memory
...
stop_server()
{
	...
	do
		...
		then
			screen -S ${SCREEN_NAME} -p 0 -X stuff "say\040Server\040will\040stop\040in\040${i}\040seconds^M"
